...
M.general = {
  n = {
    ...
    ["<leader>q"] = { "<cmd>lua require'telescope.builtin'.diagnostics({bufnr=0})<CR>", "List current file diagnostics"},
    ["<leader>Q"] = { "<cmd>lua require'telescope.builtin'.diagnostics()<CR>", "List workspace diagnostics"},
